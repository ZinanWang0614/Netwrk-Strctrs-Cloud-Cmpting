...
public class Student {
	...
	public Student(String id, String studentId, String firstName, String lastName, String joiningDate, String department, List<String> registerCourses) {
		this.id = id;
	...
	@DynamoDBAttribute(attributeName = "registerCourses")
